...
def train_val_test_split(data_frame: pd.DataFrame, shuffle=True):
    ...
    test_false, val_false = train_test_split(test_false, test_size=0.65, shuffle=shuffle)
    train_true, test_true = train_test_split(true, test_size=0.3, shuffle=shuffle)
    test_true, val_true = train_test_split(test_true, test_size=0.65, shuffle=shuffle)
